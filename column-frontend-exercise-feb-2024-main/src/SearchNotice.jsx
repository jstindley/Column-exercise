        ...
        const getNotices = async () => {
            ...
            querySnapshot.forEach((doc) => {
                    const docData = {
                        ...
                        publicationDate: new Date(doc.data().publicationDate.seconds * 1000).toDateString() 
                    }
    ...
    return (
        <BrowserRouter> 
            <div data-testid="searchNotice">
                ...
                <Routes>
                    <Route path='/' element={<NoticeResults data={searchResults} />} />
